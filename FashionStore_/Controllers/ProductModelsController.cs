...
namespace FashionStore_.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,ImageUrl,Categery,Details,Price,Stock")] ProductModel productModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,ImageUrl,Categery,Details,Price,Stock")] ProductModel productModel)
        {
